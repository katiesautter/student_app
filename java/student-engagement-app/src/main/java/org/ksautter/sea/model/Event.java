...
public class Event {
	...
	public void setStatus(String stat) {
		if (stat.equals("public") || stat.equals("private"))
        {
			this.status = stat;
		} else 
		{
			throw new RuntimeException("Status must be private or public! You put status as: " + stat);
	...
	/*
	 * private List<Event> events; public List<Event> getEvents() { return events; }
	 * 
